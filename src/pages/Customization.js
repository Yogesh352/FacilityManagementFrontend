...
const CustomContentBuilding = React.forwardRef(function CustomContent(
  ...
  const [
    openedSectionModal,
    { open: openSectionModal, close: closeSectionModal },
  ] = useDisclosure(false);
...
function CustomTreeItemBuilding({ nameOfBuilding, nameOfSections }, props) {
  return (
    ...
    >
      <TreeItem
        nodeId={nameOfBuilding}
        label={nameOfBuilding}
        ContentComponent={CustomContentBuilding}
        {...props}
      >
        {Object.keys(nameOfSections).map((section) => (
          <CustomTreeItemSection
            key={section}
            section={section}
            nameOfSections={nameOfSections[section]}
          />
        ))}
      </TreeItem>
    </TreeView>
...
function CustomTreeItemSection({ section, nameOfSections }, props) {
  return (
    <TreeItem
      nodeId={section}
      label={section}
      ContentComponent={CustomContentSection}
      {...props}
    >
...
function CustomTreeItemTag({ tag, selected }, props) {
  return (
    <TreeItem
      nodeId={tag["TagName"]}
      label={tag["TagName"]}
      ContentComponent={CustomContentTag}
      {...props}
    ></TreeItem>
  );
}
  ...
  return (
    ...
    <div className="maincontainer">
          ...
          <div>
            {Object.keys(buildingArray).map((nameOfBuilding) => (
              <CustomTreeItemBuilding
                ...
                nameOfSections={buildingArray[nameOfBuilding]}
              />
            ))}
          </div>
        </TreeView>
      ...
      <div className="rightside">
        ...
        <div
          className={
            buildingView ? "buildingcontainer" : "buildingcontainerhide"
          }
        >
          <SectionUnlocking />
        </div>
            ...
            <div className="inputname6">
              <p>
                ...
                <HoverCard width={280} shadow="md">
                  ...
                  <HoverCard.Dropdown>
                    <p>
                      Selecting this option wll allow users to checkout of a
                      facility early.
                    </p>
                  </HoverCard.Dropdown>
                </HoverCard>
