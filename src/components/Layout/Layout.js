      ...
      <>
        <div className="flex relative dark:bg-main-dark-bg">
          ...
          <Container
            className={
              activeMenu
                ? "dark:bg-main-dark-bg min-h-screen bg-main-bg  md:ml-72 w-full flex-2  flex flex-col relative p-0 max-w-full ml-0 "
                : "bg-main-bg dark:bg-main-dark-bg w-full min-h-screen flex-2  flex flex-col relative  p-0 max-w-full ml-0"
            }
          >
